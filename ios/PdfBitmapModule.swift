...
public class PdfBitmapModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    AsyncFunction("renderPdfToBitmap") { (base64Pdf: String, dpi: Int) -> [String: Any] in
      let document = try Self.openDocument(base64Pdf)
      guard let page = document.page(at: 0) else {
        throw Exception(name: "ERR_NO_PAGE", description: "PDF has no pages")
      }
      return try Self.renderPage(page, index: 0, dpi: dpi)
    }

    AsyncFunction("renderPdfToBitmaps") { (base64Pdf: String, dpi: Int) -> [[String: Any]] in
      let document = try Self.openDocument(base64Pdf)
      ...
      for index in 0..<document.pageCount {
        ...
        pages.append(try Self.renderPage(page, index: index, dpi: dpi))
      }
      return pages
    }
  }

  private static func openDocument(_ base64Pdf: String) throws -> PDFDocument {
  ...
  private static func renderPage(_ page: PDFPage, index: Int, dpi: Int) throws -> [String: Any] {
